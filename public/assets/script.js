    ...
    posts.forEach(post => {
        postCard += `
          ...
          <div class="w-11 h-11 p-0.5 rounded-full border-2 border-red-600">
            ...
            <a class="text-black text-sm font-semibold hover:underline" href="#">aslamkhan_17</a>
          </div>
          <!-- menu bar -->
          ...
          <div class="flex flex-auto items-center space-x-1">
            <a href="" class="text-sm font-semibold hover:underline">Aslam Khan</a>
            <span class="text-sm">“Give love in secret by praying for one another.”</span>
          </div>
          <!-- time -->
